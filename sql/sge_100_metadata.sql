...
EXEC sp_addextendedproperty 
    @name = 'MS_Description', 
    @value = 'Nombre de la tabla de la base de datos que aplica la regla', 
    @level0type = 'SCHEMA', @level0name = 'dbo', 
    @level1type = 'TABLE', @level1name = 'RolePermissions', 
    @level2type = 'COLUMN', @level2name = 'RpTable';
GO
...
EXEC sp_addextendedproperty 
    @name = 'MS_Description', 
    @value = 'Nombre de la tabla de la base de datos que aplica el permiso', 
    @level0type = 'SCHEMA', @level0name = 'dbo', 
    @level1type = 'TABLE', @level1name = 'UserPermissions', 
    @level2type = 'COLUMN', @level2name = 'UrTable';
GO
...
EXEC sp_addextendedproperty 
    @name = 'Log de acciones, procedimientos, triggers, permisos, ...', 
    @value = 'Estados de un cargo', 
    @level0type = 'SCHEMA', @level0name = 'dbo', 
...
EXEC sp_addextendedproperty 
    @name = 'Log de sentencias SQL ejecutas sobre la base de datos', 
    @value = 'Estados de un cargo', 
    @level0type = 'SCHEMA', @level0name = 'dbo', 
