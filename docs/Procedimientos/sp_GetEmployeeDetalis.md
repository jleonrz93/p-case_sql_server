## sp_GetEmployeeDetalis

A través de la vista `vw_EmployeeDetails` obtiene la información de un usuario predeterminado
...
```sql
CREATE OR ALTER PROCEDURE sp_GetEmployeeDetalis_JSON
    @Params NVARCHAR(MAX),
